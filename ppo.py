...
class PPO:
    ...
    def __init__(self, policy_class, env, **hyperparameters):
        ...
        logging.debug(
            f"Policy Gradient Actor-Critic with PPO initialized. \nAll attributes: {self.__dict__.items()}"
        )
    ...
    def learn(self, total_timesteps):
        ...
        while t_so_far < total_timesteps:  # ALG STEP 2
            ...
            self._log_summary(
                avg_ep_lens, avg_ep_rews, avg_actor_loss, t_so_far, i_so_far, delta_t
            )

            # Save episodic data to CSV file
            self._save_episodic_data_to_csv(
                avg_ep_lens, avg_ep_rews, avg_actor_loss, t_so_far, delta_t
            )
    ...
    def _log_summary(
        self, avg_ep_lens, avg_ep_rews, avg_actor_loss, t_so_far, i_so_far, delta_t
    ):
        """
    ...
    def _save_episodic_data_to_csv(
        self, avg_ep_lens, avg_ep_rews, avg_actor_loss, t_so_far, delta_t
    ):
        """
